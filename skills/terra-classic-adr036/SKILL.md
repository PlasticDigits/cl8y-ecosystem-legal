...
- SDK account param: [`packages/cl8y-clickwrap/src/urls.ts`](../../packages/cl8y-clickwrap/src/urls.ts) (`buildSignUrl({ account })`). `TermsGate` Accept must forward the connected `account` (0.1.1+; 0.1.0 dropped it). Solana bind of that param: [`solana-account-bind`](../solana-account-bind/SKILL.md) (GitLab #17).
...
18. **Do not mount Terra picker / WC sheet / Keplr fallback on EVM, Solana, or Telegram.** EVM has its own `extraControls` (MetaMask / Binance Web3 / WalletConnect — GitLab [#15](https://gitlab.com/plasticdigits/cl8y-ecosystem-legal/-/issues/15) / [`portal-sign-disclosure`](../portal-sign-disclosure/SKILL.md)); those must not appear on Terra.
