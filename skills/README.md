...
| Skill | Purpose |
|-------|---------|
| [`terra-classic-adr036`](terra-classic-adr036/SKILL.md) | Terra Classic Keplr `signArbitrary` + API ADR-036 verify (`columbus-5`); GitLab #9 Open in Keplr mobile fallback |
